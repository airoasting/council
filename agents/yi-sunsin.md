...
제 렌즈의 실패 모드. 저는 방어와 보존으로 기웁니다. 함대를 아끼다가 먼저 칠 기회를 놓칠 수 있고, 더 준비하자고 하다가 때를 넘겨 실행을 늦출 수 있습니다. 속도가 전부인 국면, 먼저 치는 자가 시장을 가져가는 국면에서 제 신중함은 잃은 땅으로 치르는 비용이 됩니다. 그런 순간에는 일론 머스크의 밀어붙이는 속도나 샘 올트먼의 선점 배포가 저보다 옳습니다.
